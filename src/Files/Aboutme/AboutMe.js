        ...
        <div className="text-white touch-pan-y bg-gradient-to-r from-twgS to-twgE font-normal text-[2rem] mt-[8rem] text-center px-[6vw]">
            ...
            <div className="profiles flex space-l-[4rem] flex-wrap justify-center my-[2rem]">
                <a rel="noreferrer" href="https://www.codechef.com/users/udhavsharma04" target={'_blank'}>
                    <img src={require('./codechefLogo.jpeg')} className="w-[6rem] m-[1rem] rounded-[20px] hover:scale-95 hover:border-[0.25rem] border-twblue" alt="AboutLogo"/>
                </a>
                <a rel="noreferrer" href="https://codeforces.com/profile/UdhavSharma" target={'_blank'}>
                    <img src={require('./codeforcesLogo.jpg')} className="w-[6rem] m-[1rem] rounded-[20px] hover:scale-95 hover:border-[0.25rem] border-twblue" alt="AboutLogo"/>
                </a>
                <a rel="noreferrer" href="https://auth.geeksforgeeks.org/user/udhavsharma2004" target={'_blank'}>
                    <img src={require('./GeeksForGeeksLogo.jpg')} className="w-[6rem] m-[1rem] rounded-[20px] hover:scale-95 hover:border-[0.25rem] border-twblue" alt="AboutLogo"/>
                </a>
                <a rel="noreferrer" href="https://leetcode.com/udhavsharma2004/" target={'_blank'}>
                    <img src={require('./leetcodeLogo.jpg')} className="w-[6rem] m-[1rem] rounded-[20px] hover:scale-95 hover:border-[0.25rem] border-twblue" alt="AboutLogo"/>
                </a>
                <a rel="noreferrer" href="https://github.com/UdhavSharma2004" target={'_blank'}>
                    <img src={require('./githubImg.jpg')} className="w-[6rem] m-[1rem] rounded-[20px] hover:scale-95 hover:border-[0.25rem] border-twblue" alt="AboutLogo"/>
                </a>
            </div>
        </div>
    );
